...
export type CommunityQuery = { __typename?: 'Query', community?: { __typename?: 'Community', id: string, ipfsMetadata: string, owner: any, stakingRequirement: any, communityId: any, blockTimestamp: any, blockNumber: any, transactionHash: any, members: Array<{ __typename?: 'Member', transactionHash: any, blockNumber: any, id: any, allTimeCollateral: any, stakedCollateral: any, stakedReputation: any, totalReputation: any }>, offers: Array<{ __typename?: 'Offer', id: string, blockNumber: any, metadata: string, offerId: any, stakingRequirement: any, offerStatus: string, reputationRequirement: any, blockTimestamp: any }> } | null };
...
export type MemberQuery = { __typename?: 'Query', member?: { __typename?: 'Member', id: any, totalReputation: any, stakedReputation: any, stakedCollateral: any, allTimeCollateral: any, blockTimestamp: any, blockNumber: any, transactionHash: any, trades: any, community: { __typename?: 'Community', id: string } } | null };
...
export type OfferQuery = { __typename?: 'Query', offers: Array<{ __typename?: 'Offer', id: string, metadata: string, offerId: any, stakingRequirement: any, offerStatus: string, reputationRequirement: any, blockNumber: any, blockTimestamp: any, transactionHash: any, community: { __typename?: 'Community', id: string } }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    Member(variables: MemberQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<MemberQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<MemberQuery>(MemberDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Member', 'query');
    },
    Offer(variables: OfferQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<OfferQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<OfferQuery>(OfferDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Offer', 'query');
    }
  };
}
