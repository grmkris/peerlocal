...
export interface PeerLocalZKInterface extends utils.Interface {
  functions: {
    ...
    "endOffer(uint256,uint256,bool,address)": FunctionFragment;
...
export interface PeerLocalZK extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PeerLocalZKInterface;
